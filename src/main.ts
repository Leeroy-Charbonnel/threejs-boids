...
//                         if (child.name === 'LEFT_WING') leftWingGeometry.push(geom);
//                         else if (child.name === 'RIGHT_WING') rightWingGeometry.push(geom);
//                         else bodyGeometry.push(geom);

//                     }
//                 });

//                 if (leftWingGeometry.length > 0 || rightWingGeometry.length > 0 || bodyGeometry.length > 0) {
//                     console.log(`Geometries found: ${leftWingGeometry.length} left wing, ${rightWingGeometry.length} right wing, ${bodyGeometry.length} body`);
